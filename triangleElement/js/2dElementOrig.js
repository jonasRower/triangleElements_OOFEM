...
class elementy {
    ...
    constructor(){
        ...
        this.elementy = '{"elementy": [' +
                        '{"data":' +
                            '{"element": [' +
                                '{"Souradnice":[[50,160],[70,80],[90,200]], "cisloElementu":2,"barva":"red","OznaceniVrcholu":[1,2,3]},'+
                                '{"Souradnice":[[150,160],[70,80],[90,200]], "cisloElementu":1,"barva":"#ff0066","OznaceniVrcholu":[4,2,3]},'+
                                '{"Souradnice":[[50,160],[70,80],[40,50]], "cisloElementu":3,"barva":"#ff66cc","OznaceniVrcholu":[1,2,5]}'+
                                ']' +
							'},' +
							'"Ox":20,'+
							'"Oy":20,'+
...
class vykresliVsechnyElementy {
    ...
    constructor(vsechnySouradnice, vsechnyBarvy, Ox, Oy){
        this.Ox = Ox;
        this.Oy = Oy;
        this.vykreslujVsechnyElementy(vsechnySouradnice, vsechnyBarvy);
    }
    ...
    vykreslujVsechnyElementy(vsechnySouradnice, vsechnyBarvy){
        ...
        for (var i = 0; i < vsechnySouradnice.length; i++) {
            ...
            this.vykresliElement(souradniceElement, barvaElement);
        }
    }


    vykresliElement(souradnice, barva){

        var c = document.getElementById("konzolaSilaNaKonci");
...
$(document).ready(function(){
    ...
    var vykresleniElementu = new vykresliVsechnyElementy(vsechnySouradnice, vsechnyBarvy, Ox, Oy);
...
$( "#konzolaSilaNaKonci" ).click(function(event) {
    var c = document.getElementById("konzolaSilaNaKonci");
